...
public class TravelGUI {
    ...
    public void createAndShowGUI() {
        ...
        JButton saveButton = new JButton("Save Trips");
        JButton loadButton = new JButton("Load Trips");
        ...
        searchButton.addActionListener(e -> {
            ...
            for (int i = 0; i < manager.getTrips().size(); i++) {
                Trip trip = manager.getTrips().get(i);
                if (trip.getName().toLowerCase().contains(query) ||
                    trip.getDestination().getCountry().toLowerCase().contains(query) ||
                    trip.getDestination().getCity().toLowerCase().contains(query)) {
        ...
        saveButton.addActionListener(e -> {
            try {
                ...
                JOptionPane.showMessageDialog(frame, "Trips saved to trips.txt");
        ...
        loadButton.addActionListener(e -> {
            try {
                ...
                updateTripList();
                JOptionPane.showMessageDialog(frame, "Trips loaded from trips.txt");
            } catch (IOException ex) {
